package com.goodanser.osmglass.phone.ui.preview
...
import com.goodanser.osmglass.phone.gps.LocationProvider
...
class RoutePreviewFragment : Fragment(R.layout.fragment_route_preview) {
    ...
    private fun computeRoute(destination: com.goodanser.osmglass.phone.ui.search.Place, origin: LatLng?) {
