package com.goodanser.osmglass.protocol.transport;
 ...
 * {@link com.goodanser.osmglass.protocol.FrameReader#readNext()} and the existing reconnect path never fires.
 *
 * <p>Per session:
 * <ul>
